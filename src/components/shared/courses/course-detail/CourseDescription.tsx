...
const CourseDescription: React.FC<courseDescription> = ({ courseDescriptionData }) => {
  return (
    <Section className="course_description1 !m-4 !p-0 sm:!m-0">
      <Container className=" relative -inset-y-36 rounded-md bg-[#f5f5f5] !p-0 !shadow-xl sm:-inset-y-12 sm:max-w-[520px] md:!max-w-[620px] lg:!max-w-[1200px] 2xl:!max-w-[1400px]">
