...
export const cybersecuritylearnersReviewLowerCarousel: LearnersReview[] = [
  {
    learner_Name: "Aadesh",
    learner_Position: "Data Analyst",
    learner_Image: "/images/trainer.png",
...
export const cybersecurityvoiceFromStudents: VoiceFromStudentsProps[] = [
  {
    id: "1",
...
export const ConfusedAboutCourses: VoiceFromStudentsProps[] = [
  {
    id: "1",
    light: "/images/videothumb.png",
    url: "/videos/get-started.mp4",
...
export const CybersecurityMasterpageFaqs: FaqItemProps[] = [
  {
    id: 1,
